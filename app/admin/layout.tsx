...
export default function AdminLayout({ children }: { children: ReactNode }) {
  return <div className="admin-shell">
    ...
    <AdminBottomNav/>
    <style>{`
      .admin-shell{min-height:100dvh;background:radial-gradient(circle at 85% 0%,rgba(16,185,129,.12),transparent 30%),radial-gradient(circle at 8% 22%,rgba(59,130,246,.07),transparent 28%),#09090b;color:#f4f4f5}
      ...
      .admin-shell input,.admin-shell select,.admin-shell textarea{box-shadow:inset 0 1px 0 rgba(255,255,255,.035)}
      ...
      @media(max-width:1023px){
        ...
        .admin-shell main>div>div{padding-bottom:88px!important}
        ...
        .admin-shell .admin-notification-trigger{top:10px!important;right:10px!important}
      }

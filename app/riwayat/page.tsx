...
export default function RiwayatPage() {
  ...
  function submit(e: React.FormEvent) {
    ...
    if (!/^RMK-[A-Z0-9]{8}$/.test(value)) {
      setError("Format Order ID tidak valid. Contoh: RMK-8X2A9P7Q");
      return;
    }
    setError("");

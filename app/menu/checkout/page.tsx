...
export default function CheckoutPage() {
  ...
  const checkoutSubtotal = useMemo(() => Object.entries(cart).reduce((sum, [, quantity]) => sum + quantity, 0), [cart]);
